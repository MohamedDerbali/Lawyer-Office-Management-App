...
session_start();
$C=new CotentieuxC();
$Contentieux=$C->afficherAllContentieuxClient($_GET['id']);
            ...
            <div class="container">
                <?php                 if  ($_SESSION['role'] == 'Admin') {
                    ...
                    <button class="btn btn-primary"
                            onclick="location.href='FormulaireGlobalAddContentieuxAdmin.php?id=<?php echo $_GET['id'] ?>'">
                    ...
                    ?>
                    <button class="btn btn-primary"
                            onclick="location.href='FormulaireGlobalAddContentieuxAgent.php?id=<?php echo $_GET['id'] ?>'">
                        Ajouter un Contentieux
                    </button>
                    <?php
                }
