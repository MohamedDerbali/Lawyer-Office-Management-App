...
if (!empty($_SESSION)) {
    ...
    $d = new \DateTime('now');
    $c = new Cotentieux($_SESSION['id'], $_POST['idclient'], $_POST['categorie'], "en cours", $_POST['date'], $_POST['NumAffaire'], $_POST['objectif'], $_POST['idTribual'], $_POST['petition'], $_POST['sujet']);;
