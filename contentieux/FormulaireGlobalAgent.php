            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="card col-md-8 offset-2" style="width:500px;padding: 20px;">
                        ...
                        <div id="div0">
                            <h4 class="m-0 text-dark" style="text-align: center">Ajouter un Client</h4>
                            <form action="../Client/ajoutclient.php" onsubmit="return submitForm(this);"  method="post">
                                <div class="form-group">
                                    <label for="exampleFormControlInput1">Nom</label>
                                    <input type="text" class="form-control" id="exampleFormControlInput3" name="nom" placeholder="nom" required="" oninvalid="this.setCustomValidity('هذه الخانة إلزامية')" oninput="this.setCustomValidity('')">
                                </div>
                                <div class="form-group">
                                    <label for="exampleFormControlInput1">Prenom</label>
                                    <input type="text" class="form-control" id="exampleFormControlInput3" name="prenom" placeholder="prenom" required="" oninvalid="this.setCustomValidity('هذه الخانة إلزامية')" oninput="this.setCustomValidity('')">
                                </div>
                                <div class="form-group">
                                    <label for="exampleFormControlInput1">Date Naissance</label>
                                    <input type="date" class="form-control" id="exampleFormControlInput3" name="dateNaissance" placeholder="Date Naissance" required="" oninvalid="this.setCustomValidity('هذه الخانة إلزامية')" oninput="this.setCustomValidity('')">
                                </div>
                                <div class="form-group">
                                    <label for="exampleFormControlInput1">CIN</label>
                                    <input type="number" class="form-control" id="exampleFormControlInput3" name="identite" placeholder="CIN" required="" oninvalid="this.setCustomValidity('هذه الخانة إلزامية')" oninput="this.setCustomValidity('')">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleFormControlInput3" name="adresse" placeholder="addresse" required="" oninvalid="this.setCustomValidity('هذه الخانة إلزامية')" oninput="this.setCustomValidity('')">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="exampleFormControlInput1">Fix</label>
                                ...
                                <button type="submit" class="btn btn-info" name="addclient">Ajouter client</button>
                                </div>
                            </form>
                            <br>
                            <button class="btn btn-success" id="next1" style="float:right;" onclick="hidecurrentShowNext('#div0','#div1')">next</button>
                        </div>
                        ...
                        <div id="div1">
                        <h4 class="m-0 text-dark" style="text-align: center">Ajouter un Contentieux</h4>
                    <form action="AjoutContenttieux.php"  onsubmit="return submitForm(this);" method="post">
                        ...
                        <button class="btn btn-success" id="next1x" style="float:right;" onclick="hidecurrentShowNext('#div1','#div2')">next</button>
                        </div>
                        <div id="div2">
                            ...
                            <form method="post" action="../Paiement/ajoutPaiement.php" onsubmit="return submitFormJustificatif(this);" enctype="multipart/form-data">
                                ...
                                <input type="submit" class="btn btn-success" id="pain" value="ajouter paiement">
