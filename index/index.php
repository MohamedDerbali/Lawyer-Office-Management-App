...
<div class="wrapper">
 ...
 <?php include('Elements/header.php'); ?>
    ...
    <?php                 if  ($_SESSION['role'] == 'Admin') {
        ...
        ?>
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="Client/ajoutCliente.php" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="Tribual/AddTribuale.php" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Ajouter un Tribuale</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="Tribual/AfficheTribual.php" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Consulter les Tribuales</p>
                    </a>
                </li>
    ...
    ?>
                    <li class="nav-header">Fonctions</li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <?php                 if  ($_SESSION['role'] == 'Admin') {
                        ?>
                        <a href="contentieux/FormulaireGlobal.php" class="nav-link">
                            <?php }
                            else{
                            ?>
                    ...
                    <li class="nav-item">
                        <?php                 if  ($_SESSION['role'] == 'Admin') {
                        ?>
                        <a href="contentieux/AfficherContentieuxAdmin.php" class="nav-link">
                            <?php }
                            else{
                            ?>
