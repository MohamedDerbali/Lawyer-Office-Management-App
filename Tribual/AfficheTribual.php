...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container">
                <h1 class="m-0 text-dark">قائمة المحاكم </h1>
                    <div class="card">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    foreach ($tribuals as $tr):
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $tr['doyen'] ?></td>
                                            <td><a class="fas fa-eye" href="DetailTribual.php?id=<?php echo $tr['id'] ?>"></a></td>
                                            <td><a class="fas fa-trash" style="color: red" href="DeleteTribual.php?id=<?php echo $tr['id'] ?>"></a></td>
